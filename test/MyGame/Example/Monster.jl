# automatically generated by the FlatBuffers compiler, modified to add
# work around for circular references
...
Monster{T}(buf::AbstractVector{UInt8}, pos::Integer=0) where {T} = FlatBuffers.read(Monster{T}, buf, pos)
